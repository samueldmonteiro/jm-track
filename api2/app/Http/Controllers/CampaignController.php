...
use App\Application\UseCase\Campaign\FindByIdByCompany\FindCampaignByIdByCompanyInputDTO;
use App\Application\UseCase\Campaign\FindByIdByCompany\FindCampaignByIdByCompanyUseCase;
...
class CampaignController extends Controller
{
    ...
    public function findByIdByCompany(Request $request, FindCampaignByIdByCompanyUseCase $useCase): JsonResponse
    {
        try {
            $response = $useCase->execute(
                new FindCampaignByIdByCompanyInputDTO(
                    $request->id,
                    Auth::user()->id
                )
            );
